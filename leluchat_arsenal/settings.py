# pylint: skip-file
"""
Django settings for leluchat_arsenal project.
...
class Dev(Configuration):
    ...
    SECRET_KEY = 'django-insecure-#^!(#!lv@je=%71$v4!=%l+x=9gs_x$dwl7l)k)#-brj+t0gx='
    ...
    ROOT_URLCONF = 'leluchat_arsenal.urls'
    ...
    WSGI_APPLICATION = 'leluchat_arsenal.wsgi.application'
